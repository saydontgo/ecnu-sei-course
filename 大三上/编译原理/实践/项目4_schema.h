...
vector<DFA *> dfa_list;
string key_list[78] = {" ", "auto", "break", "case", "char", "const", "continue", "default", "do", "double", "else",
...
vector<string> non_terminal_index = {"", "program", "decls", "decl", "stmt", "compoundstmt", "stmts", "ifstmt", "whilestmt", "assgstmt", "boolexpr", "boolop", "arithexpr", "arithexprprime", "multexpr", "multexprprime", "simpleexpr"};
/*
    非终结符编号：
    1: program
    2: stmt
